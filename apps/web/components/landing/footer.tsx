    ...
    <footer>
      <div className="mx-auto max-w-[1320px] border-t border-(--l-border) px-6 py-14 md:py-18">
        <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
          <div>
            <div className="font-mono text-xs uppercase tracking-widest text-(--l-fg-2)">
              Open Agents
            </div>
          ...
          <div>
            ...
            <div className="mt-4 flex flex-col gap-2">
              <a
                ...
                className="font-mono text-sm text-(--l-fg-2) transition-colors hover:text-(--l-fg)"
              >
                AI SDK
              </a>
              <a
        ...
        <div className="mt-10 flex items-center justify-between">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-(--l-fg-2) transition-colors hover:text-(--l-fg-2)"
          >
            <svg
              viewBox="0 0 76 65"
              className="h-4"
